...
namespace DAL
{
    public class Comment
    {
        ...
        public int Update(Model.Comment comment)
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
                string sql = "update Comment setCommentContent=@CommentContent,CommrntTime=@CommentTime where commentID=@commentID";
        ...
        public int Delete(int id)
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
                string sql = "dalete from comment where commentId=@id";
